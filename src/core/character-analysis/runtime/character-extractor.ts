/**
 * Legacy multi-pass LLM character extractor (detail + relationships).
 * Prefer `runCharacterAnalysisPipeline` for roster/coref; this class remains for
 * job detail/relationship steps and older call sites.
 */
